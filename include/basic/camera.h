...
class camera {
    ...
    public:
        color (*color_function)(const ray&, const color&, const shared_ptr<hittable>, const shared_ptr<hittable>, int);
        ...
        void set_color_function(color (*ray_color)(const ray&, const color&, const shared_ptr<hittable>, const shared_ptr<hittable>, int));
